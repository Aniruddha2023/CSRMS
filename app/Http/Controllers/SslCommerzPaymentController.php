...
class SslCommerzPaymentController extends Controller
{
    ...
    public function checkout(Request $request)              //----------------------
    {
        ...
        if($house_add_fee > 1000){
            ...
            $post_data['total_amount'] = $house_add_fee;
        }
        ...
        $post_data['location_id'] =  $request->location_id;
    ...
    public function Landsuccess(Request $request)
    {
        ...
        return view('landlord/payment/success_payment');
    ...
    public function fail(Request $request)
    {
        ...
        return view('landlord/payment/failed_payment');
    }
