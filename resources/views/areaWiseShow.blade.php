...
@section('content')
    ...
    <div class="container">
        <div class="row my-5" id="content">
            @forelse ($houses as $house)
                <div class="col-md-4">
                    <div class="card m-3">
                        ...
                        <div class="card-body">
                            <p>
                            <h4><strong><i class="fas fa-map-marker-alt"> {{ $house->location->name }}, Chattogram</i>
                                </strong>
                            </h4>
                            </p>
                            ...
                            <hr>
                            <p class="grey"><i class="fas fa-bed"></i> {{ $house->area_size }} Bedrooms <i
            ...
            @empty
                <h2 class="m-auto py-2 text-white bg-dark p-3 area-wise-not-available">Area Not Available right now</h2>
            @endforelse
        </div>
