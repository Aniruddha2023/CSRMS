...
<head>
    ...
    <title>csrms.com - Checkout Hosted | SSLCommerz</title>
...
<body class="bg-light">
    <div class="container">
        <div class="py-5 text-center">
            <h1 style="color: blue">csrms.com</h1>
            <h2>Payment Authorization Form</h2>
            <p>Powerd by: SSLCommerz</p>
            <p style="color:red">You need to Pay <strong>{{ $price }}</strong> BDT. To add this Area.</p>
        ...
        <footer class="my-5 pt-5 text-muted text-center text-small">
            <p class="mb-1">&copy; 2020 csrms.com</p>
