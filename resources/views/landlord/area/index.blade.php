            ...
            <div class="col-md-9">
                ...
                <div class="card mt-5">
                    <div class="card-header">
                        <h3 class="card-title float-left"><strong>Our All Locations ({{ $areacount }})</strong></h3>

                        <a href="{{ route('landlord.area.create') }}" class="btn btn-success btn-md float-right c-white">Add
                            new Location <i class="fa fa-plus"></i></a>
                    </div>
                    <!-- /.card-header -->
                    @if ($areas->count() > 0)
                        <div class="">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($area->user_id == Auth::id())
                                                        <a href="{{ route('landlord.area.edit', $area->id) }}"
                                                    ...
                                                    <form id="delete-form-{{ $area->id }}"
                                                        action="{{ route('landlord.area.destroy', $area->id) }}"
