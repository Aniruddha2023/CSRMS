    ...
    <div class="invoice-area">
        <div class="invoice-wrapper">
                ...
                <div class="invoice-flex-contents">
                    <div class="invoice-logo">
                        <img style="height: 100px; width: 100px;"
                            src="{{ public_path('frontend/img/header_logo.png') }}" alt="">
                    </div>
            ...
            <div class="item-description">
                <h5 class="table-title">{{ __('Area Details') }}</h5>
                    ...
                    <table class="custom--table">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    @foreach ($users as $user)
                                        <span class="data-span"> {{ $user->name }}</span> <br>
                                        <span class="data-span"> {{ $user->email }}</span><br>
                                        <span class="data-span"> {{ $user->contact }}<br>
                                    @endforeach
                                </td>
                                <td>
                                    {{ $order->created_at }}<br>
                                ...
                                <td>
                                    <span class="data-span"> {{ __('Area Add Fee:') }} </span> {{ $order->amount }}
                                    <br>
                            ...
                            <span class="data-span"> {{ __('Coupon Amount:') }} </span>$5 <br> -->
                                    ...
                                    <span class="data-span"> {{ __('Payment Status:') }} </span><span
                                        style="color:green;">{{ $order->status }}</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
