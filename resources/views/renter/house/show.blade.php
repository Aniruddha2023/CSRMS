                                ...
                                @if ($alreadyReviewed != null)
                                    <tr>
                                        ...
                                        <td style="text-align: justify">{{ $alreadyReviewed->opinion }}
                                            <br><a href="{{ route('renter.review.edit', $alreadyReviewed->id) }}"
                                                class="btn btn-info btn-sm my-2">Edit</a>
                                        </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('renter.review') }}" method="POST">
                                                    ...
                                                    <input type="hidden" name="location_id" value="{{ $house->id }}">
