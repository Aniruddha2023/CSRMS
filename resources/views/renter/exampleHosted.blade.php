...
<head>
    ...
    <title>CSRMS- Checkout Hosted | SSLCommerz</title>
...
<body class="bg-light">
    <div class="container">
        <div class="py-5 text-center">
            <h1 style="color: blue">CSRMS</h1>
            <h2>Payment Authorization Form</h2>
            <p>Powerd by: SSLCommerz</p>
            <p style="color:red">You need to Pay <strong>{{ $rent }}</strong> BDT. To Book this Area.</p>
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2 order-md-1">
                ...
                <form action="{{ url('/checkout2') }}" method="POST" class="needs-validation">
                    <input type="hidden" value="{{ csrf_token() }}" name="_token" />

                    <!----- Hidden Value ----->

                    <input type="hidden" name="user_id" class="form-control" value="{{ $user->id }}">
                    <input type="hidden" name="location_id" class="form-control" value="{{ $location_id }}">
                    <input type="hidden" name="rent" class="form-control" value="{{ $rent }}">
                    <!----- Hidden Value ----->
        ...
        <footer class="my-5 pt-5 text-muted text-center text-small">
            <p class="mb-1">&copy; 2020 CSRMS</p>
