    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image text-center">
                <img src="{{ Auth::user()->image != null ? asset('storage/profile_photo/' . Auth::user()->image) : asset('backend/img/user2-160x160.jpg') }}"
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                @if (Request::is('admin*'))
                    ...
                    <li class="nav-item has-treeview">
                        <a href="{{ route('admin.house.index') }}"
                            class="nav-link {{ Request::is('admin/house*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item has-treeview">
                        <a href="/chatify" class="nav-link {{ Request::is('renter/pending/booking') ? '' : '' }}">
                            <!-- <a href="/chatify"> -->
                ...
                @if (Request::is('landlord*'))
                    ...
                    <li class="nav-item has-treeview">
                        <a href="{{ route('landlord.house.pending') }}"
                            class="nav-link {{ Request::is('landlord/space-pending') ? 'active' : '' }}">
                            <i class="fa fa-home" aria-hidden="true"></i>
                            <p class="pl-2">
                                Area Status
                            </p>
                ...
                @if (Request::is('renter*'))
                    ...
                    <li class="nav-item has-treeview">
                        <a href="{{ route('renter.areas') }}"
                            class="nav-link {{ Request::is('renter/areas') ? 'active' : '' }}">
                            <i class="fa fa-map-marker" aria-hidden="true"></i>
                            <p class="pl-2">Locations</p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item has-treeview">
                        <a href="{{ route('renter.allHouses') }}"
                            class="nav-link {{ Request::is('renter/house*') ? 'active' : '' }}">
                            <i class="fa fa-home" aria-hidden="true"></i>
                            <p class="pl-2">
                                Areas
                            </p>
